...
slug: "/artik-pythonda-elif-yazmak-zorunda-degilsiniz"
date: 2021-11-26
tags:
  - Python
  - CPython
...
Bu noktadan itibaren bilgisayarınızın fan seslerinizi ve `tkinter` gibi paketlerinden çıkan hataları görmezden gelebilirsiniz.
...
Dokümantasyona bakmadan ilk alımda gelen IDE de `elif` keywordunu bulup bunu değiştirmekti. 354. satırın oraları şöyle değiştirdim.
...
200 IQ haraket . `elif` i değitik ama Python internal modullerinde hala `elif` kullanıyor. Dolayısıyla parser hata çıkartıyor.
