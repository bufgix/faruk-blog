...
[Expo]() kullanmak. Expo kullanmak yeni başlayan biri için oldukça kolay bir yol olabilir.
...
Evet bu [zımbırtı]() olmadan ben artık uygulama _yazmıyorum_. İlerde anlatacağım çoğu şeyde Typescript
...
Ben global state için uygulamarımda [Redux]() ve [Redux-Toolkit]() kullanıyorum. Reduxdan önce [Mobx](),
[Mobx-State-Tree]() gibi kütüphaneler de kullandım. Redux o zamanlar bana bir sürü reducer yazdığın,
